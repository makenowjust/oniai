...
fetch "${BASE}/Scripts.txt"                            "data/Scripts.txt"
fetch "${BASE}/ScriptExtensions.txt"                   "data/ScriptExtensions.txt"
fetch "${BASE}/PropertyValueAliases.txt"               "data/PropertyValueAliases.txt"
